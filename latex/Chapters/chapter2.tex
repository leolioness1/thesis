...
\subsection{Retrogressive Thaw Slump (RTS)}  \label{rts_intro}
\paragraph{}
...
\begin{figure}[hbt!]
    ...
    \caption{Example of an \gls{RTS} in the Arctic, kindly provided by Dr. Nitze}
    \label{fig_RTS_big}
\end{figure}
